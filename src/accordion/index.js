 ...
 * 3. "use strict"
 * 4. Наследование происходит с помощью extends, а расширение методов с помощью вызова super()(для конструктора) и super['methodName']()(для метода)
 * 5. В стрелочных функциях нет super()
 * */
